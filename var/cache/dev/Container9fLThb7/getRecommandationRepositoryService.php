 ...
 */
class getRecommandationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecommandationRepository' shared autowired service.
     *
     * @return \App\Repository\RecommandationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecommandationRepository.php';

        return $container->privates['App\\Repository\\RecommandationRepository'] = new \App\Repository\RecommandationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
