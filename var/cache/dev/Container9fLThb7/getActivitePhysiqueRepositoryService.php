 ...
 */
class getActivitePhysiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivitePhysiqueRepository' shared autowired service.
     *
     * @return \App\Repository\ActivitePhysiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivitePhysiqueRepository.php';

        return $container->privates['App\\Repository\\ActivitePhysiqueRepository'] = new \App\Repository\ActivitePhysiqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
