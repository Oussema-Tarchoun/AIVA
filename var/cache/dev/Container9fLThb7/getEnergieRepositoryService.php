 ...
 */
class getEnergieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnergieRepository' shared autowired service.
     *
     * @return \App\Repository\EnergieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnergieRepository.php';

        return $container->privates['App\\Repository\\EnergieRepository'] = new \App\Repository\EnergieRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
