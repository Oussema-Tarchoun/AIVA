 ...
 */
final class Version20260218204446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_261f98f157d1ad4 ON activite_physique');
        ...
        $this->addSql('ALTER TABLE chapitre ADD CONSTRAINT `fk_chapitre_cours` FOREIGN KEY (id_cours) REFERENCES cours (id) ON UPDATE CASCADE ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_261F98F157D1AD4 ON activite_physique (objectif_id)');
        $this->addSql('ALTER TABLE activite_physique ADD CONSTRAINT FK_261F98F157D1AD4 FOREIGN KEY (objectif_id) REFERENCES objectif (id)');
