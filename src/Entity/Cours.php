...
#[Assert\Positive(message: 'L\'identifiant du cours doit être positif.')]
private ?int $id_cours = null;
     ...
     */
    #[ORM\OneToMany(targetEntity: Chapitre::class, mappedBy: 'id_cours', orphanRemoval: true)]
    private Collection $chapitres;

    // === Nouvelle relation vers User ===
